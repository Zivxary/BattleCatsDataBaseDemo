...
public class WebDownloadThreadTest {

    private Integer[] needDataId;

    public WebDownloadThreadTest(final Integer...ids) {
        this.needDataId = ids;
    }
    ...
    public void run() {
        ...
        IDownloadFactory downloadDataFactory = new FakeDownloadFactory(needDataId);
        WebDownloadThread webDownloadThread = new WebDownloadThread(queue, downloadDataFactory);
